<template>
  <div class="row">
    <div class="col mb-3">
      <label title="The coordinate (in meters) of the point at the center of the transducer">Position
        X</label>
      <input type="number" step="any" class="form-control" placeholder="0.00" v-model.number="positionX" />
    </div>
    <div class="col mb-3">
      <label title="The coordinate (in meters) of the point at the center of the transducer">Position
        Y</label>
      <input type="number" step="any" class="form-control" placeholder="0.00" v-model.number="positionY" />
    </div>
    <div class="col mb-3" v-if="!is2d">
      <label title="The coordinate (in meters) of the point at the center of the transducer">Position
        Z</label>
      <input type="number" step="any" class="form-control" placeholder="0.00" v-if="!is2d" v-model.number="positionZ" />
    </div>
  </div>
  <div class="row">
    <div class="col mb-3">
      <label title="Indicate the direction the source is pointing">Direction X</label>
      <input type="number" step="any" class="form-control" placeholder="-0.143" v-model.number="directionX" />
    </div>
    <div class="col mb-3">
      <label title="Indicate the direction the source is pointing">Direction Y</label>
      <input type="number" step="any" class="form-control" placeholder="-0.068" v-model.number="directionY" />
    </div>
    <div class="col mb-3" v-if="!is2d">
  ...
  <div class="mb-3">
    ...
    <input type="number" step="any" class="form-control" placeholder="0.06" v-model.number="aperture" />
  </div>
  <div class="mb-3">
    <label title="The number of point sources to use when simulating the transducer">Points</label>
    <input type="number" class="form-control" placeholder="3000" v-model.number="numPoints" />
  </div>
  <div class="mb-3">
