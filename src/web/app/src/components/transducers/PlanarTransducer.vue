  ...
  <fieldset>
    <div class="row">
      <div class="col mb-3">
        <label for="positionX" data-bs-toggle="tooltip" data-bs-placement="right"
          ...
          X</label>
        <input type="number" step="any" class="form-control" name="positionX" placeholder="0.00" required />
      </div>
      <div class="col mb-3">
        <label for="positionY" data-bs-toggle="tooltip" data-bs-placement="right"
          title="The coordinate (in meters) of the point at the center of the transducer">Position
          Y</label>
        <input type="number" step="any" class="form-control" name="positionY" placeholder="0.00" required />
      </div>
      <div class="col mb-3" data-3d-only="true" hidden>
        <label for="positionZ" data-bs-toggle="tooltip" data-bs-placement="right"
          title="The coordinate (in meters) of the point at the center of the transducer">Position
          Z</label>
        <input type="number" step="any" class="form-control" name="positionZ" placeholder="0.00"
    ...
    <div class="row">
      <div class="col mb-3">
        ...
        <input type="number" step="any" class="form-control" name="directionX" placeholder="-0.143" required />
      </div>
      <div class="col mb-3">
        ...
        <input type="number" step="any" class="form-control" name="directionY" placeholder="-0.068" required />
      </div>
      <div class="col mb-3" data-3d-only="true" hidden>
    ...
    <div class="mb-3">
      ...
      <input type="number" step="any" class="form-control" name="aperture" placeholder="0.06" required />
    </div>
    <div class="mb-3">
      ...
      <input type="number" class="form-control" name="numPoints" placeholder="3000" required />
    </div>
    <div class="mb-3">
